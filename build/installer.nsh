...
!define MINERADIO_INSTALL_MARKER ".52music-install-root"
...
!macro customInstall
  ...
  ${IfNot} ${Errors}
    FileWrite $0 "52MUSIC install root$\r$\n"
    FileWrite $0 "appId=com.52music.desktop$\r$\n"
    FileClose $0
  ${EndIf}
!macroend
...
Function MineradioUseFirstAvailableInstallDir
  ...
  StrCpy $INSTDIR "C:\52MUSIC"
  Return

  driveD:
    StrCpy $INSTDIR "D:\52MUSIC"
    Return
  driveE:
    StrCpy $INSTDIR "E:\52MUSIC"
    Return
  driveF:
    StrCpy $INSTDIR "F:\52MUSIC"
    Return
  driveG:
    StrCpy $INSTDIR "G:\52MUSIC"
    Return
  driveH:
    StrCpy $INSTDIR "H:\52MUSIC"
    Return
  driveI:
    StrCpy $INSTDIR "I:\52MUSIC"
    Return
  driveJ:
    StrCpy $INSTDIR "J:\52MUSIC"
    Return
  driveK:
    StrCpy $INSTDIR "K:\52MUSIC"
    Return
  driveL:
    StrCpy $INSTDIR "L:\52MUSIC"
    Return
  driveM:
    StrCpy $INSTDIR "M:\52MUSIC"
    Return
  driveN:
    StrCpy $INSTDIR "N:\52MUSIC"
    Return
  driveO:
    StrCpy $INSTDIR "O:\52MUSIC"
    Return
  driveP:
    StrCpy $INSTDIR "P:\52MUSIC"
    Return
  driveQ:
    StrCpy $INSTDIR "Q:\52MUSIC"
    Return
  driveR:
    StrCpy $INSTDIR "R:\52MUSIC"
    Return
  driveS:
    StrCpy $INSTDIR "S:\52MUSIC"
    Return
  driveT:
    StrCpy $INSTDIR "T:\52MUSIC"
    Return
  driveU:
    StrCpy $INSTDIR "U:\52MUSIC"
    Return
  driveV:
    StrCpy $INSTDIR "V:\52MUSIC"
    Return
  driveW:
    StrCpy $INSTDIR "W:\52MUSIC"
    Return
  driveX:
    StrCpy $INSTDIR "X:\52MUSIC"
    Return
  driveY:
    StrCpy $INSTDIR "Y:\52MUSIC"
    Return
  driveZ:
    StrCpy $INSTDIR "Z:\52MUSIC"
    Return
FunctionEnd
...
Function MineradioDisableUnsafeOldUninstallers
  ...
  Pop $1
  ${If} $1 == "1"
    DetailPrint "Skip unsafe legacy 52MUSIC uninstaller: $0"
    StrCpy $2 "1"
  ${EndIf}
...
Function MineradioDeleteLegacyUninstallerFileIfMissingMarker
  ...
  ${If} $0 != ""
    ...
    ${If} $1 != ""
      ...
      DetailPrint "Remove legacy 52MUSIC uninstaller file: $1"
...
Function MineradioValidateInstallDir
  ...
  ${If} $1 == ":"
    ...
    ${OrIf} $0 == "c"
      ...
      ${AndIf} $3 != "1"
      ${AndIf} $4 != "1"
        MessageBox MB_ICONSTOP|MB_OK "检测到这台电脑还有 D-Z 盘，52MUSIC 不安装到 C 盘。请改选 D 盘或其它非 C 盘的 52MUSIC 文件夹。$\r$\n$\r$\n如果电脑只有 C 盘，安装器会自动放行 C:\52MUSIC。"
        Abort
      ${EndIf}
    ${EndIf}
  ${EndIf}
  ...
  ${OrIf} $1 != "\52MUSIC"
  ${AndIf} $1 != "\52music"
    MessageBox MB_ICONSTOP|MB_OK "安装目录必须是独立的 52MUSIC 文件夹。请选择一个上级目录，安装器会自动创建 52MUSIC 子文件夹。"
    Abort
  ${EndIf}
  ...
  MessageBox MB_ICONSTOP|MB_OK "为避免卸载时误删其它文件，52MUSIC 不能安装到已有文件的非专属目录。请新建或选择一个空的 52MUSIC 文件夹。$\r$\n$\r$\n当前路径：$INSTDIR"
  Abort
...
Function MineradioWelcomeShow
  ...
  ${NSD_CreateLabel} 22u 20u 82u 10u "52MUSIC"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
  SetCtlColors $0 "3257F7" "FFFFFF"

  ${NSD_CreateLabel} 22u 42u 226u 30u "52MUSIC 安装"
  Pop $0
  ...
  ${NSD_CreateLabel} 22u 96u 238u 24u "为这台电脑安装 52MUSIC。默认安装到 D:\52MUSIC，下一步可以自由选择其它位置。"
  Pop $0
...
Function MineradioDirectoryBrowse
  nsDialogs::SelectFolderDialog "选择 52MUSIC 安装文件夹" "$INSTDIR"
  Pop $0
  ${If} $0 != error
  ${AndIf} $0 != ""
    Push "$0"
...
Function MineradioDirectoryShow
  ...
  ${NSD_CreateLabel} 22u 122u 238u 12u "默认推荐：D:\52MUSIC；选盘符会自动建文件夹。"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
...
Function un.MineradioValidateUninstallDir
  ...
  Pop $1
  ${If} $0 != $1
    MessageBox MB_OK|MB_ICONSTOP "当前卸载路径不是 52MUSIC 专属目录，已阻止卸载以避免误删其它文件。$\r$\n$\r$\n当前路径：$INSTDIR$\r$\n安全路径应为：$0"
    SetErrorLevel 2
    Quit
  ${EndIf}
  StrCpy $INSTDIR "$0"
  ...
  Pop $0
  ${If} $0 != "1"
    MessageBox MB_OK|MB_ICONSTOP "无法确认当前目录属于 52MUSIC，已阻止卸载以避免误删其它文件。$\r$\n$\r$\n当前路径：$INSTDIR"
    SetErrorLevel 2
    Quit
  ${EndIf}
FunctionEnd
